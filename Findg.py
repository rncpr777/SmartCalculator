...
class MyApp(App):
    def __init__(self):
        super().__init__()
        self.inp = TextInput(text='Масса тела(КГ)',
                             size_hint=(0.8, 0.08),
                             pos_hint={'y': 0.77, 'x': 0.1},
                             font_size='34sp',
                             multiline=False)
        self.out = TextInput(text='*Сила тяжести у поверхности*',
                             size_hint=(0.8, 0.08),
                             pos_hint={'y': 0.6, 'x': 0.1},
                             font_size='25sp',
                             multiline=False,
                             readonly=True)
    ...
    def build(self):
        ...
        lay.add_widget(Label(text='Сила тяжести у поверхности',
                             font_size='34sp',
