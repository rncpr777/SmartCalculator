...
class MyApp(App):
    def __init__(self):
        super().__init__()
        self.inp1 = TextInput(text='Деформация(М)',
                              size_hint=(0.8, 0.08),
                              pos_hint={'y': 0.77, 'x': 0.1},
                              font_size='34sp',
                              multiline=False)

        self.inp2 = TextInput(text='Коэфф. упругости',
                              size_hint=(0.8, 0.08),
                              pos_hint={'y': 0.67, 'x': 0.1},
                              font_size='34sp',
                              multiline=False)

        self.outp = TextInput(text='Сила упругости',
                              size_hint=(0.8, 0.08),
    ...
    def build(self):
        ...
        lay.add_widget(Label(text='Сила Упругости',
                             font_size='45sp',
